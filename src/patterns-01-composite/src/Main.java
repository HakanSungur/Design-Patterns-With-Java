//Composite deseninin amacý bütüne ve bütünü oluþturan parçalara ayný þekilde eriþimi saðlamaktýr. 
public class Main {
	...
	public static void main(String[] args) {
		...
		b12.Add(new Metin("deðiþkenler"));
		b12.Add(new Metin("kontrol"));
		b12.Add(new Metin("dÃ¶ngÃ¼ler"));
		b12.Add(new Metin("fonksiyonlar"));
		b1.Add(b12);
		
		Bolum b2 = new Bolum("Deðiþkenler");
